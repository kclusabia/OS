...
//
var APP_NAME: string    = "Infinite OS";   // 'cause Bob and I were at a loss for a better name.
var APP_VERSION: string = "9.12";   // What did you expect?
...
var _DefaultFontFamily = "arial";        // Ignored, I think. The was just a place-holder in 2008, but the HTML canvas may have use for it.
